...
function updateTimer() {
  const targetDate = new Date("November 29, 2025 22:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '543812389021'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '543812389021'; // Número para el primer botón
